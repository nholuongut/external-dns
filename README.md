...
This README is a part of the complete documentation, available [here](https://github.com/nholuongut/external-dns).
...
ExternalDNS supports multiple DNS providers which have been implemented by the [ExternalDNS contributors](https://github.com/nholuongut/external-dns). Maintaining all of those in a central repository is a challenge, which introduces lots of toil and potential risks.
...
A [breaking change](https://github.com/nholuongut/external-dnspull/2281) was added in external-dns v0.10.0.
...
is not strictly required. Provider listed [here](https://github.com/nholuongut/external-dns/s#status-of-in-tree-providers)
