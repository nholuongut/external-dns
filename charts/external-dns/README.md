...
**Homepage:** <https://github.com/nholuongut/external-dns>
...
* <https://github.com/nholuongut/external-dns>
...
```shell
helm repo add external-dns https://github.com/nholuongut/external-dns
```
...
See [documentation](https://github.com/nholuongut/external-dns#new-providers) for more info on available providers and tutorials.
...
- [AWS](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/aws.md#using-helm-with-oidc)
- [akamai-edgedns](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/akamai-edgedns.md#using-helm)
- [cloudflare](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/cloudflare.md#using-helm)
- [digitalocean](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/digitalocean.md#using-helm)
- [godaddy](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/godaddy.md#using-helm)
- [ns1](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/ns1.md#using-helm)
- [plural](https://github.com/nholuongut/external-dnsblob/master/docs/tutorials/plural.md#using-helm)
...
| provider.name | string | `"aws"` | _ExternalDNS_ provider name; for the available providers and how to configure them see [README](https://github.com/nholuongut/external-dnsblob/master/charts/external-dns/README.md#providers). |
