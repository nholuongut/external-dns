...
CRD source watches for a user specified CRD to extract [Endpoints](https://github.com/nholuongut/external-dnsblob/HEAD/endpoint/endpoint.go) from its `Spec`.
...
Here is typical example of [CRD API type](https://github.com/nholuongut/external-dnsblob/HEAD/endpoint/endpoint.go) which provides Endpoints to `CRD source`:
