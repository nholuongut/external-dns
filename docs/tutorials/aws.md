...
hostnames based upon known hostname suffixes which are defined in [aws.go](https://github.com/nholuongut/external-dnsblob/master/provider/aws/aws.go#L65). If a hostname
...
* Limit the [sources watched](https://github.com/nholuongut/external-dnsblob/master/pkg/apis/externaldns/types.go#L364) when the `--events` flag is specified to specific types, namespaces, labels, or annotations
