...
PowerDNS provider support was added via [this PR](https://github.com/nholuongut/external-dnspull/373), thus you need to use external-dns version >= v0.5
...
[CRD source](https://github.com/nholuongut/external-dnsblob/master/docs/contributing/crd-source.md) provides a generic mechanism and declarative way to manage DNS records in PowerDNS using external-dns.
