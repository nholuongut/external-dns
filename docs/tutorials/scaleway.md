...
The following example are suited for development. For a production usage, prefer secrets over environment, and use a [tagged release](https://github.com/nholuongut/external-dnsreleases).
